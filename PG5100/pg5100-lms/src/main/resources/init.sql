...
INSERT INTO EVENT (id, description, eventType, title, FK_SUBJECT) VALUES (1, 'Repetisjonsforelesning, Jarle Hansen',  'LECTURE', 'Repetisjonsforelesning', 2);
INSERT INTO EVENT (id, description, eventType, title, FK_SUBJECT) VALUES (2, 'Gjesteforelesning, Mark Zuckerberg', 'LECTURE', 'Gjesteforelesning', 2);
